    ...
    <form onSubmit={handleSubmit} className="mb-8">
      <div className="flex items-center border-b-2 border-blue-500 py-2">
        <input
          ...
          className="appearance-none bg-transparent border-none w-full mr-3 py-1 px-2 leading-tight focus:outline-none dark:text-white text-gray-900 placeholder:text-gray-500 dark:placeholder:text-gray-400"
        />
        {city && (
          <button
            type="button"
